...
void __attribute__((interrupt, no_auto_psv)) _PWMInterrupt(void){
    ...
    PDC1 = Result + RAMBuffer[9] + RAMBuffer[10];           // The duty cycle of first PWM
    ...
    PDC2 = Result + RAMBuffer[9] + RAMBuffer[10];           // The duty cycle of second PWM
    ...
    PDC3 = Result + RAMBuffer[9] + RAMBuffer[10];           // The duty cycle of third PWM
